...
#include <audioenginebaseapo.h> // added
...
#endif
            bFoundSomething = TRUE;
            hrWarn = MakeNewWidget(spPart, __uuidof(IAudioLoudness), nCtrlId++);
            hrWarn = MakeNewWidget(spPart, __uuidof(IAudioAutoGainControl), nCtrlId++);
            hrWarn = MakeNewWidget(spPart, __uuidof(IDeviceSpecificProperty), nCtrlId++);
        }
    }
